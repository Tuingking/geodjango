...
from geodjango.exceptions import DataNotFound
...
from indonesia.tests.dataset import building_ds as data
from indonesia.utils import to_OSM_coordinate
...
config = {
    "KELURAHAN_DATA": "indonesia/tests/dataset/kelurahan_jakarta.json",
